...
Project{
    ...
    ofApp {
        ...
        files: [
            ...
            'src/Hud.cpp',
            'src/MidiModifier.cpp',
            'src/ModifierBezierNoise.cpp',
            'src/ModifierColor.cpp',
            'src/ModifierExpand.cpp',
            'src/ModifierFactory.cpp',
            'src/ModifierFactory.cpp~',
            'src/ModifierGlitch.cpp',
            'src/ModifierMove.cpp',
            'src/ModifierRotation.cpp',
            'src/ModifierScale.cpp',
            'src/ModifierShapeCreator.cpp',
            'src/ModifierSoundSetter.cpp',
            'src/ModifierVeil.cpp',
            'src/OscWrapper.cpp',
            'src/PostFx.cpp',
